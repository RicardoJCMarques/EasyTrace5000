 ...
 * Version 4.3 - Added Minkowski operations support
 */
    ...
    geometries: {
        ...
        boolean: {
            ...
            clips: {
                ...
                rabbit: {
                    type: 'svg',
                    scale: 0.8,  // Increased from 0.3 to 0.8 for better visibility
                    initialPos: [200, 200],
        ...
        minkowski: {
            patterns: {
                ...
                diamond: {
                    type: 'polygon',
                    data: [[0, -20], [20, 0], [0, 20], [-20, 0]]
                }
            },
            paths: {
                rectangle: {
                    type: 'polygon',
                    data: [[50, 50], [250, 50], [250, 250], [50, 250]]
                },
                triangle: {
                    type: 'polygon',
                    data: [[100, 80], [300, 150], [150, 280]]
                },
                line: {
                    type: 'polyline',  // Fixed: Added type property
                    data: [[50, 200], [150, 100], [250, 200], [350, 150]]
                }
            },
            defaults: {
                pattern: 'circle',
