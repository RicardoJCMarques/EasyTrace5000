 ...
 * @description Mach3 post-processing module for Windows-based hobby/semi-pro CNCs
...
(function() {
    ...
    class Mach3PostProcessor extends BasePostProcessor {
        ...
        generateHeader(options) {
            ...
            lines.push('(Post-processor: Mach3)');
            lines.push('');
            ...
            // Optional tool change with pause
            if (options.toolNumber) {
                lines.push(`T${options.toolNumber} M6`);
                lines.push(`\G43 H${options.toolNumber}`);
