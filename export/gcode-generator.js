...
(function() {
    ...
    class GCodeGenerator {
        ...
        generate(toolpathPlans, options) {
            ...
            this.currentProcessor.resetState(); // Resets currentSpindle to 0
            this.untransformedPosition = { x: 0, y: 0, z: 0 };
            ...
            // 2. Handle Initial Spindle Command
            ...
            if (firstPlanWithSpindle) {
                ...
                // Call the silent setSpindle
                const spindleGcode = this.currentProcessor.setSpindle(spindle);
                if (spindleGcode) {
            ...
            for (const plan of toolpathPlans) {
                ...
                // 3b. Handle Tool Changes (Conceptual)
                ...
                for (const cmd of plan.commands) {
                    ...
                    for (const commandToProcess of commandsToProcess) {
                        ...
                        const gcode = this.currentProcessor.processCommand(transformedCmd, options, metadata);
                        if (gcode) {
                            output.push(gcode);
                        }
