...
(function() {
    ...
    class LayerRenderer {
        ...
        renderPreviewLayer(layer) {
            ...
            const toolDiameter = layer.metadata?.toolDiameter || 0.2;
            ...
            layer.primitives.forEach(primitive => {
                ...
                this.ctx.lineWidth = toolDiameter;  // Tool diameter as stroke width
                ...
                this.primitiveRenderer.renderPrimitive(primitive, 'transparent', layer.color, false);
